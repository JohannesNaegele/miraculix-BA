...
#define BitsPerCode256_1 1
#define CodesPerUnit256_1 (BytesPerUnit * BitsPerByte / BitsPerCode256_1)
#define CodesPerBlock256_1 (CodesPerUnit256_1 * UnitsPerBlock256)
...
long static inline Blocks256_1(Ulong snps){    
  return 1L + (snps - 1L) / CodesPerBlock256_1;
}
...
long static inline UnitsPerIndiv256_1(Ulong snps){    
  return Blocks256_1(snps) * UnitsPerBlock256;
}
